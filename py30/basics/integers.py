...
# id() -> ввыодит номер ячейки в памяти
...
# % -> для получение остатка от деления 
# a = 89
# b = 9
# print(a % b)
...
#  abs -> модуль числа -> |-9| из отрицательного сдлеает положительное
# print(abs(-9))
# print(abs(-10))
...
# print(divmod(9, 4))
# divmod(15, 5)  # результат (3, 0)

#  round()
# print(round(559/5))
# print(559/5)
# print(round(777/8, 2))  # второй элемент, указывает сколько чисел оставить после запятой
...
# print(math.sqrt(100))
# math.sqrt(36)  #6 корень от числа 36 = 6
